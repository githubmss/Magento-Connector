<?php
namespace Mssbuilder\Connector\Block\Adminhtml\Dashboard\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    public function __construct(
        ...
        \Mssbuilder\Connector\Model\Status $options,
        array $data = []
    ) {
    ...
    public function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'index'    => 'image',
                'renderer' => '\Mssbuilder\Connector\Block\Adminhtml\Grid\Renderer\LogoImage',
