<?php
namespace Mssbuilder\Connector\Controller\token;
...
class Getconfiguration extends \Magento\Framework\App\Action\Action
{
    ...
    const XML_SETTING_GOOGLE_CLIENT_ID = 'mssbuilder_social/mss_google_key/client_id';
    const XML_SETTING_GOOGLE_SECRET_ID = 'mssbuilder_social/mss_google_key/client_secret';
    const XML_SETTING_FACEBOOK_ID      = 'mssbuilder_social/mss_facebook_key/facebook_id';
    const XML_SETTING_GOOGLE_SENDER_ID = 'mssbuilder_pushnotification/setting_and/googlesenderid';
